...
export class CardService {
   ...
   */
  create(cardForm: Card): Observable<Message> {
    return this.httpClient.post<Message>(baseURL, cardForm);
  }
   ...
   */
  update(cardForm: Card): Observable<Message> {
    return this.httpClient.put<Message>(`${baseURL}/${cardForm.cardId}`, cardForm);
  }
   ...
   */
  fetch(pagination: Pagination, sorting: Sorting, searchForm: Card): Observable<HttpResponse<Card[]>> {
